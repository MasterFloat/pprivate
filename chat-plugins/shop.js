...
exports.commands = {
	...
	shop: function (target, room, user) {
		...
		this.sendReplyBox(
			...
			'<tr><td>Icon</td><td>Compra un icono de un pokemon al lado de tu nick para 3 salas. Debe ser una imagen 32x32. Contactar con un Admin para obtener este art&iacute;culo.</td><td>4000</td></tr>' +
			...
			'<tr><td>IconSupport</td><td>Si ya tienes un icono. Puedes cambiarlo por otro diferente.</td><td>1000</td></tr>' +
