...
var commands = exports.commands = {
	...
	groups: function (target, room, user) {
		if (!this.canBroadcast()) return;
		this.sendReplyBox(
			"+ <b>Voice</b> - They can use ! commands like !groups, join battles and talk during moderated chat<br />" +
			"$ <b>Operator</b> - The above, and they can warn, mute, and manage tournaments<br />" +
			"% <b>Driver</b> - The above, and they can also lock users and check for alts<br />" +
